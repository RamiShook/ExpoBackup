...
echo"<br>this orer is new so 5000 Delivery <br> reserve Date IS ".$rDate;
echo "<br> reserve Date IS ".$rDate;
echo "<br>SO The Finl Price is :".$PriceCalc;
    }else{
        $PriceCalc = $PriceCalc+4000;
        echo "<br> this order is old so 4000 Delivery <br> reserve Date IS ".$rDate;
echo "<br>SO The Finl Price is :".$PriceCalc;
...
$excel2 = $excel2->load('TOPSPEEDFONT.xlsx'); // Empty Sheet
...
//$excel2->getActiveSheet()->getPageSetup()->setPaperSize(PHPExcel_Worksheet_PageSetup::PAPERSIZE_expo);
$excel2->getActiveSheet()->getPageSetup()->setPrintArea('A1:I14');
