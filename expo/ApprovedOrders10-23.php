    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      <header class="mdl-layout__header">
        <div class="mdl-layout__header-row">
          <!-- Title -->
          <span class="mdl-layout-title">Approved Orders WASKA 2020-10-21</span>
...
<!--        &nbsp; &nbsp; &nbsp;Search By Name: <input type="text" id="NameInput" onkeyup="SearchByName()" placeholder="Search By Name.." title="Type The Product Name"> -->
    ...
    $wkid=$_SESSION['uid'];
     ...
     WHERE multiple_reserved.multiple_reserve_status like '%Approved%'
     AND 
     multiple_reserved.waska LIKE '%2020-10-21%'
    ...
    $PriceCalc = $PriceCalc+ $row['price'] ;
              ...
              echo '<tr id="tr'.$row['multiple_reserve_id'].'">
                  ...
                  if($data['counts'] == $rowcounter){
                      ...
                      Reserved By The Worker: <strong>".$row['worker_Full_Name']." <br> Order Status: ".$row['multiple_reserve_status']." <br> note: ".$row['multiple_reserve_note']."</strong><br> Shipment Number: ".$row['shipment_number']." <br> WASKA: ".$row['waska']."   <br> CLient Address: ".$row['client_Address']."</strong><hr></td>";
                      $rowcounter=1;
                      $PriceCalc=0;
