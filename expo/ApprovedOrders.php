    ...
    $PriceCalc = $PriceCalc+ $row['price'] ;
              ...
              echo '<tr id="tr'.$row['multiple_reserve_id'].'">
                  ...
                  if($data['counts'] == $rowcounter){
                      ...
                      Reserved By The Worker: <strong>".$row['worker_Full_Name']." <br> Order Status: ".$row['multiple_reserve_status']." <br> note: ".$row['multiple_reserve_note']."</strong><br> Shipment Number: ".$row['shipment_number']." <br> WASKA: ".$row['waska']."</strong><hr></td>";
                      $rowcounter=1;
                      $PriceCalc=0;
