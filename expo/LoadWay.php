    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      <header class="mdl-layout__header">
        <div class="mdl-layout__header-row">
          <!-- Title -->
          <span class="mdl-layout-title">Reservations Between <?php echo ".$strt. AND .$to." ?></span>
...
<br><input type="text" placeholder="2020-09-01" id ="begin_date"> </input> &nbsp; &nbsp; &nbsp; <input type="text" placeholder="2020-10-01" id ="end_date"> </input>  
<input type="button" value="filter"onclick="FilterDt()"></button>
...
<br> <?PHP
    ...
    $wkid=$_SESSION['uid'];
     ...
     WHERE  CAST(reserve_date AS DATE) BETWEEN '$strt' AND '$to'
     ORDER BY multiple_reserved.reserve_date DESC")or die(mysqli_error($connection));
     $t = mysqli_num_rows($q);
...
echo"5000 Delivery";
        ...
        echo "4000 Delivery";
                      ...
                      echo "<u>The Above Order Is For The Client: </u><strong>".$row['client_FullName']."</strong>&nbsp; &nbsp; <u> Phone:</u><strong>".$row['client_Phone']."</strong><br>Client Address:<strong>".$row['client_Address']."</strong><br><u>The Total Price Is</u>:<strong> ".$PriceCalc."</strong> <br>Order Date:<strong>".$row['reserve_date']."</strong><br>
...
function confirmrv(x){
  ...
  function FilterDt(){
    ...
    window.open('https://cedarslandshoes.com/expo/LoadWay.php?strt='+strt_date+'&to='+end_date)
 ...
 /*
  ...
  function GoPrev(x){
      x=x+1000;
      window.open('https://cedarslandshoes.com/expo/LoadWay.php?strt=1000&to='+x);
      console.log(x);
      
      
  }
  function GoNext(x){
      alert("-_- Not Programmed")
  }
