...
<input type="radio" id="All" name="sz"  value="All"> </input> <label for="All">All Sizes</lable>
&nbsp &nbsp 
<input type="radio" id="Custom" name="sz"  checked Value="Custom"> </input> <label for="Custom">Custom Sizes</lable>
&nbsp
&nbsp
