...
multiple_reserved_product.Check_Status,
    ...
    where multiple_reserved.multiple_reserve_id in (select multiple_reserve_id from multiple_reserved_product,products where (multiple_reserved_product.multiple_reserve_product_id = products.product_id and products.product_Quantity >0 ) and Check_Status = 0) AND multiple_reserved.multiple_reserve_status = 'Fulfillment' ORDER BY multiple_reserved.reserve_date DESC ")or die("error".mysqli_error($connection));
     $t = mysqli_num_rows($q);
