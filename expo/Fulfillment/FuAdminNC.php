...
multiple_reserved_product.Check_Status,
     ...
     WHERE multiple_reserved.multiple_reserve_status= 'Fulfillment' AND multiple_reserved.multiple_reserve_id <= 6673 ORDER BY multiple_reserved.reserve_date DESC ")or die("error".mysqli_error($connection));
     $t = mysqli_num_rows($q);
