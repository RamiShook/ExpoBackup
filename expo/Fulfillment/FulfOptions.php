<a href='#' class="mdl-navigation__link" id="usern" disabled><?php chkss() ?></a>
        <!--  index.php?profile  -->
          ...
          <a class="mdl-navigation__link" href="./BrowseAvailable.php">Browse Available Products.</a>
                                  <a class="mdl-navigation__link" href="./Tamer.php">Tamer❤️.</a>
                                  <a class="mdl-navigation__link" href="./Gargour.php">Gargour.</a>

          <a class="mdl-navigation__link" href="./Fulfillment.php">Show Order's(GT 6674)</a>
          <a class="mdl-navigation__link" href="./Requests.php">Show Return/Replacement Requests.</a>

          <a class="mdl-navigation__link" href="./Fulfillment2.php">Old Fulfillment(LT 6674) </a>
                             <a class="mdl-navigation__link" href="./FuAdminNC2.php">ADMIN PRINT(GT 6674) </a>
          ...
          <a class="mdl-navigation__link" href="./LastetProducts.php">Show/Edit Last 24h Product's.</a>
                        <a class="mdl-navigation__link" href="./Entry/AddQuantity.php">Add Quantity To Existing Product.</a>
                        <a class="mdl-navigation__link" href="./Entry/ChangePrice.php">Change Product Price.</a>
