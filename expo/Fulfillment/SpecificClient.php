...
multiple_reserved_product.Check_Status,
     ...
     WHERE multiple_reserve_client_id = '$clid'
        ...
        echo "4000 Delivery";
                      ...
                      echo "<u>The Above Order Is For The Client: </u><strong>".$row['client_FullName']."</strong>&nbsp; &nbsp;
                       ...
                       <br><u> Address:</u><strong>".$row['client_Address']."</strong>
                        ...
                        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <div style='color:red'>This Client Have ".$ClientOrderCount['COUNT(*)']." Orders To Send.  &nbsp &nbsp &nbsp &nbsp<a href='./SpecificClient.php?clientid=".$row['multiple_reserve_client_id']."'>Filter All This Client Orders</a> </div> <br> 
                        Order Notes : <strong>".$row['multiple_reserve_note']." </strong><br>  Order Status : <strong>".$row['multiple_reserve_status']." </strong> <hr></td>";   
                      $rowcounter=1;
                      $PriceCalc=0;
