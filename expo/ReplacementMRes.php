    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      <header class="mdl-layout__header">
        <div class="mdl-layout__header-row">
          <!-- Title -->
          <span class="mdl-layout-title">Replacement / return orders
         </span>
...
<!--        &nbsp; &nbsp; &nbsp;Search By Name: <input type="text" id="NameInput" onkeyup="SearchByName()" placeholder="Search By Name.." title="Type The Product Name"> -->
    ...
    multiple_reserved.shipment_number,
     ...
     multiple_reserved.multiple_reserve_status like '%Sen%' ORDER BY multiple_reserved.reserve_date DESC ")or die("error");
     $t = mysqli_num_rows($q);
...
$PriceCalc = 0;
  ...
  while($row = mysqli_fetch_assoc($q)){
    ...
    $TEMPPCODE=$row['product_Code'];
                        //<input type="button" value="Return!" onclick="ReturnProduct('.$row['multiple_reserve_id'].','.$row['multiple_reserve_product_id'].',\''.$TEMPPCODE.'\','.$row['quantity'].')"></input> 
              echo '
              <tr id="tr'.$row['multiple_reserve_id'].'">
                  ...
                  if($data['counts'] == $rowcounter){
                      ...
                      echo "<u>The Above Order Is For The Client: </u><strong>".$row['client_FullName']."</strong>&nbsp; &nbsp;
                       <u> Phone:</u><strong>".$row['client_Phone']."</strong><br><u>The Total Price Is</u>:<strong> ".$PriceCalc."</strong> <br>Order Date:<strong>".$row['reserve_date']."</strong> <BR> Shipment Number: <strong>".$row['shipment_number']."</strong>
                       <br> 
