              ...
              <tr id="tr'.$row['multiple_reserve_id'].'">
                  ...
                  if($data['counts'] == $rowcounter){
                      ...
                      echo "<u>The Above Order Is For The Client: </u><strong>".$row['client_FullName']."</strong>&nbsp; &nbsp;
                       <u> Phone:</u><strong>".$row['client_Phone']."</strong><br><u>The Total Price Is</u>:<strong> ".$PriceCalc."</strong> <br>Order Date:<strong>".$row['reserve_date']."
                        <br> note: ".$row['multiple_reserve_note']."</strong><hr></td>";
                      $rowcounter=1;
                      $PriceCalc=0;
                    ...
                    <br> <br> <input type="button" id="'.$mutiplereserveid.'" onclick="confirmrv(this.id,this)" value="Confirm This Reservation"></input> 
                    <br><input type="button" id='.$row['multiple_reserve_id'].' onclick="AddNote(this.id,this)" value="Add Note" ></td></tr>
                    ';
...
xmlhttp.open("GET","./Functions.php?SetNote="+Note+"&NoteId="+thsid,false);
xmlhttp.send();   
}
                  function del(x,ths){
                    btnid=x;
...
(function(){
    ...
    'use strict';
    var snackbarContainer = document.querySelector('#demo-toast-example');
    var data = {message: 'The System Said: not sended'};
    snackbarContainer.MaterialSnackbar.showSnackbar(data);
  }());
}
}
...
xmlhttp.open("GET","./NewFunctions.php?changeToFf="+oid+"&rnd="+timestamp,false);
