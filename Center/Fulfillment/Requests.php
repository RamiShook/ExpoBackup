...
// To Get The Worker WWho Make The Reservation
    //get the worker id
$queryText = "SELECT multiple_reserve_worker_id FROM multiple_reserved WHERE multiple_reserve_id = '$TMP_order_id'";
              ...
              <td>'.$row['new_order_details_product_id_qty'].'</td>
                  ...
                  if($data['counts'] == $rowcounter){
                      ...
                      echo "<u>The Above Order Is For The Client: </u><strong>".getClientName($TMP_order_id)."</strong>&nbsp; &nbsp;
                       <u> Phone:</u><strong>".getClientPhone($TMP_order_id)."</strong><br><u>The Total Price Is</u>:<strong> </strong> <br>Order Date:<strong>".getoDate($TMP_order_id)."</strong> <br>
                        This Order Has Done By: ".$worker_Full_Name."<hr></td>";
