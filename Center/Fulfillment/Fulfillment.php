    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      ...
      <span class="mdl-layout-title"><div id="meee"> <a href='index.php'> EXPO</a></div></span>
        ...
        <?php if(isset($_SESSION['type']) && ($_SESSION['type']=="Centerworker")){
          ...
          }else if(isset($_SESSION['type'])&& ($_SESSION['type']=="CenterFulfillment") ){
...
multiple_reserved_product.Check_Status,
     ...
     WHERE  
     (multiple_reserved.multiple_reserve_status= 'Fulfillment' AND multiple_reserved.multiple_reserve_id > 6673) ORDER BY multiple_reserved.reserve_date DESC ")or die("error".mysqli_error($connection));
     $t = mysqli_num_rows($q);
